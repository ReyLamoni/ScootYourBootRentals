 ...
 *   2. Email notifications via Resend when a new inquiry arrives
...
// Rate-limit login to slow brute-force attempts
...
/**
 * POST /api/login
 * Compares submitted password against bcrypt hash in .env
 */
...
app.post('/api/inquiry', async (req, res) => {
  try {
    ...
    if (!resendKey || !notifyEmail) {
      console.warn('Resend not fully configured — skipping notification.');
